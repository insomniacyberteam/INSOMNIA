...
sleep 1
echo ""
echo  $white"[#]> Insominia Cyber Team Was Here ... "
read enter
exit
}
...
echo  $white"         ******************************************************"
echo  $white"         #                                                    #"
echo  $white"         # $cyan  Author: CyberTron$white                                #"
echo  $white"         # $cyan  Contact Me In:$red insomcyberteam@gmail.com$white          #"
echo  $white"         # $cyan  Changelog: $red 18-11-2018   $white                        #"
echo  $white"         # $cyan  Team: $red Insomnia Cyber Team$white                       #"
echo  $white"         # $cyan  Follow My Ig: @insomcyberteam$white                    #"
echo  $white"         # $cyan  Thank To:CyberTron-Zakaria96-Roy77-Legion        #"
echo  $white"         #                                                    #"
echo  $white"         ******************************************************"
date
echo  $blue"DIATAS JAM YA KENTOD"
echo  $red"SELAMAT DATANG DI TOOLS KAMI"
echo  $white"DAN SILAKAN DIPILIH YANG MAU DI INSTALL"
echo ""
...
if [ $bro = 11 ] || [ $bro = 11 ]
then
echo " Thanks To Insomnia Cyber Team "
sleep 1
echo " CyberTron Was Here "
sleep 1
echo " Fuck You "
sleep 1
echo " MDFK "
